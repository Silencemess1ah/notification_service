...
public class RedisConfig {
    ...
    public RedisMessageListenerContainer container(
            ...
            MessageListenerAdapter messageListener, MessageListenerAdapter profileViewEventListener,
            ChannelTopic channelTopic) {
        RedisMessageListenerContainer container = new RedisMessageListenerContainer();
        container.setConnectionFactory(connectionFactory);
        container.addMessageListener(messageListener, channelTopic);
        container.addMessageListener(profileViewEventListener, profileViewChannelTopic());
        return container;
    }
    ...
    ChannelTopic profileViewChannelTopic() {
        return new ChannelTopic(properties.getChannels().get("profile_view").getName());
    }
}
