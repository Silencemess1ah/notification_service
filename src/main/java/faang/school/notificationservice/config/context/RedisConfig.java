...
public class RedisConfig {
    ...
    @Bean
    MessageListenerAdapter followerMessageListenerAdapter(FollowerEventListener followerEventListner) {
        return new MessageListenerAdapter(followerEventListner);
    }
